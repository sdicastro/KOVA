...
def learn(*,
    ...
    **network_kwargs        keyword arguments to the policy / network builder. See baselines.common/policies.py/build_policy and arguments to a particular type of network
    ...
    vferr = 0.5 * tf.reduce_mean(tf.square(pi.vf - ret))
    ...
    if vf_with_fisher:
        ...
        losses = losses + [vferr]
        loss_names = loss_names + ['value_loss']
        optimgain = optimgain + vferr
    ...
    klgrads = tf.gradients(dist, get_pi_trainable_variables("pi"))
